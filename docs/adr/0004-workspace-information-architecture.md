...
解析ワークスペースの詳細レイアウトはGitHub #96で3案を比較し、2026-07-27に利用者が
推奨構成を承認した。段階レール、中央キャンバス、右インスペクタを骨格とし、必要時だけ
中央プロットの大表示と4方式比較へ切り替える。
...
- 解析タブはプロトタイプ検証のGateを通過した骨格を維持し、Level 4–6を段階追加する。
